...
const routes = [
    ...
    {
        path: 'travel-request',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_travel-request_travel-request_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/travel-request/travel-request.module */ 5528)).then(m => m.TravelRequestPageModule)
    },
    {
        path: 'about',
...
/* harmony import */ var _capacitor_community_capacitor_googlemaps_native__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @capacitor-community/capacitor-googlemaps-native */ 2441);
...
let AppComponent = class AppComponent {
    constructor() {
        _capacitor_community_capacitor_googlemaps_native__WEBPACK_IMPORTED_MODULE_2__.CapacitorGoogleMaps.initialize({
            key: src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.mapsKey
        });
    }
};
...
const environment = {
    production: false,
    mapsKey: 'AIzaSyD9NSe7Vw5fbGjhmMGSPmNr2pWnapPrNBE'
};
/*
